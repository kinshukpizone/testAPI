...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240725042621_add-Admin-Tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Admin.Banner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Admin.Pages", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Admin.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Admin.Permission", b =>
                {
                    b.HasOne("Domain.Entities.Admin.Pages", "PageNavigation")
                        .WithMany()
                        .HasForeignKey("PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Account.ApplicationUser", "UserNavigation")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Admin.Product", b =>
                {
                    b.HasOne("Domain.Entities.Admin.Category", "CategoryNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Location.City", b =>
                {
                    b.HasOne("Domain.Entities.Location.State", "StateNavigation")
                        .WithMany("Cities")

...
namespace webapi.Controllers
{
    ...
    public class ProductController : BasedController
    {
        ...
        public async Task<IActionResult> UpdateAsync(Guid id, ProductModel model)
        {
            CustomJsonResponse<bool> customJsonResponse = new CustomJsonResponse<bool>();
            if (ModelState.IsValid)
            {
        ...
        {
            CustomJsonResponse<PaginationResponse<ProductModel>> customJsonResponse = new();
            if (ModelState.IsValid)
            {
        ...
        {
            CustomJsonResponse<ProductModel?> customJsonResponse = new CustomJsonResponse<ProductModel?>();
